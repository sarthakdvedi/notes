...
20. gen key ---->string newStr =  to_string(x) + "_ " + to_string(y);   {`int to string`}
21. int x = stoi(str);  { `string to int` }
22. count(s.begin(),s.end(),target)
```
...
- take a variable and do +/-.  eg. -> in valid parenthesis problem
...
## Good Revision deserving problems -
